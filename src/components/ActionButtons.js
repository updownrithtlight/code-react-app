...
const ActionButtons = ({ onSync, onBatchGenerate,onBatchGenerateFront,onBaseFront, }) => (
  <div style={{ marginBottom: 16 }}>
    ...
    <Button type="primary" onClick={onBaseFront} icon={<PlusOutlined />} style={{ marginLeft: 8 }}>
      批量生成react-base代码
    </Button>
